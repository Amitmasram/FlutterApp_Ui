  ...
  Widget _furnitureScore(Furniture furniture) {
    return Row(
      children: [
        ...
        Text(furniture.score.toString(), style: h3Style),
      ],
    ).fadeAnimation(1.0);
  }
    ...
    widget = isHorizontal == true
        ? Column(
            children: [
              ...
              Text(furniture.title.addOverFlow,
                      style: h4Style.copyWith(fontWeight: FontWeight.w600))
                  .fadeAnimation(0.8),
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(furniture.title, style: h3Style).fadeAnimation(0.8),
